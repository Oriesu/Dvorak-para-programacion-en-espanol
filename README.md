...
Subir los dos primeros en orden en el menú que aparecerá en la barra superior al descargar `https://github.com/Oriesu/UrOwnKeyboard.git` o introducir mediante los comandos que permite dicho proyecto.
